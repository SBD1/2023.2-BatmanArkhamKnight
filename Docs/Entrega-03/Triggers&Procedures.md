...
Os desencadeadores são usados para manter a integridade referencial, mantendo um registro das atividades realizadas na tabela. Os procedimentos são usados para realizar tarefas definidas ou especificadas pelos usuários. Abaixo seguem os Triggers&Procedures:
